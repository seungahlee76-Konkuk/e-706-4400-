export const DEFAULT_PROJECT_INFO = {
  ...
  updatedAt: '2026-06-01T04:45:00Z'
};
...
해외 유수 의료기관 및 국내 빅5 출신 전문의가 상주합니다. 고난도 심장 수술 및 심폐·간이식 마취를 전담하는 고숙련 의료진이 대거 합류해 수도권 남부 진료 서비스를 선도합니다.`,
    images: [
...
권선구청, 우체국, 보건소 등 공공기관이밀집한 서수원 행정타운의 중심지로 공무원 및 방문객의 유입이 활발합니다.`,
    images: [
...
export const DEFAULT_CARDNEWS_DATA = [
  {
    id: 'medical',
    title: '의료',
